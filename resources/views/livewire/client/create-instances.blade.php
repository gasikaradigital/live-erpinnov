                                            ...
                                            <div class="tw-border-t dark:tw-border-gray-700 tw-pt-6">
                                                <div class="tw-flex tw-justify-between tw-items-center">
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        wire:target="store">
                                                        <span wire:loading.remove wire:target="store">Créer l'instance</span>
                                                        <span wire:loading wire:target="store">Création en cours...</span>
                                                        ...
                                                        <svg wire:loading wire:target="store"
                                                            ...
                                                            fill="none"
                                                            viewBox="0 0 24 24">
                                                            <circle class="tw-opacity-25"
                                                                    cx="12"
                                                                    cy="12"
                                                                    r="10"
                                                                    stroke="currentColor"
                                                                    stroke-width="4"></circle>
                                                            <path class="tw-opacity-75"
                                                                fill="currentColor"
