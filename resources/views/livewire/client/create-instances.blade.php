                            ...
                            <div class="relative">
                               ...
                               <!-- Avant le formulaire principal, ajoutons le sélecteur de type -->
                                        ...
                                        <label class="relative group cursor-pointer">
                                            ...
                                            <div class="p-4 rounded-xl border-2 transition-all duration-200
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <h3 class="font-medium text-gray-900">Création Automatique</h3>
                                                        <p class="text-sm text-gray-500">Basé sur votre entreprise (exemple : {{ $autoName ?: 'nom-généré' }})</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </label>
                                        ...
                                        <label class="relative group cursor-pointer">
                                            ...
                                            <div class="p-4 rounded-xl border-2 transition-all duration-200
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <h3 class="font-medium text-gray-900">Création Manuelle</h3>
                                                        <p class="text-sm text-gray-500">Personnalisez votre nom ({{ $name ?: 'nom-personnalisé' }})</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </label>
                                ...
                                <a href="{{ route('instance.create')}}" wire:navigate
                                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-500 transition-colors">
