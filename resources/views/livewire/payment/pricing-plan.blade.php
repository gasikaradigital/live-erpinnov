...
<div class="bg-gray-50 min-h-screen py-12 mt-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"> {{-- Réduit max-w-7xl à max-w-4xl --}}
        ...
        {{-- Liste des plans --}}
        <div class="mt-6 space-y-4"> {{-- Réduit l'espacement --}}
            @foreach($plans as $plan)
                <div x-data="{ open: false }"
                     class="bg-white rounded-xl shadow-sm hover:shadow transition-all duration-200"> {{-- Réduit l'ombre et le radius --}}
                    {{-- En-tête du plan (toujours visible) --}}
                    <div @click="open = !open"
                         class="p-4 cursor-pointer"> {{-- Réduit le padding --}}
                    ...
                    <div x-show="open"
                        ...
                        <div class="p-4"> {{-- Réduit le padding --}}
                            {{-- Features en colonnes --}}
                            <div class="grid md:grid-cols-2 gap-4"> {{-- Réduit le gap --}}
