<nav class="fixed inset-x-0 top-0 z-50 backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="flex items-center">
                <a href="/" class="flex items-center gap-3 group">
                    <img class="h-9 w-auto transform transition group-hover:scale-105"
                         ...
                         alt="Logo">
                    <span class="font-display font-semibold text-lg bg-gradient-to-r from-primary-600 to-primary-800 bg-clip-text text-transparent">
                        ERP INNOV
                    </span>
                </a>
            </div>
            ...
            <div class="flex items-center gap-6">
                @auth
                    ...
                    <button class="relative p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <span class="absolute top-1 right-1 h-2 w-2 rounded-full bg-primary-600"></span>
                ...
                @else
                    <div class="flex items-center gap-4">
                        <a href="{{ route('login') }}"
                           class="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white px-4 py-2 text-sm font-medium rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                            Se connecter
                        </a>
                        <a href="{{ route('inscription') }}"
                           class="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 text-sm font-medium rounded-lg transition-colors shadow-sm hover:shadow">
                            S'inscrire
                        </a>
                    </div>
                @endauth
